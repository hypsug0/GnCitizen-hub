    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp_create', models.DateTimeField(auto_now_add=True, verbose_name='Create timestamp')),
                ('timestamp_update', models.DateTimeField(auto_now=True, verbose_name='Update timestamp')),
